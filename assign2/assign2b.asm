...
main:							// Setting main label to indicate start of main code
	...
	mov	w19, 522133279 				// Setting value of multicand to 522133279 
	mov	w20, 200				// Setting value of multiplier to 200
...
print:							// Label for printing results
	...
	mov	w2, multp				// Setting second hex value for the results string 
